...
export const DEVELOPERS_DOCS: DevDocPage[] = [
  ...
  },
  {
    ...
    sections: [
      {
        heading: "Minimum setup for a new website",
        body: [
          {
            kind: "cards",
            items: [
              ...
              {
                eyebrow: "Measure",
                title: "Google Search Console and GA4",
                description:
      ...
      {
        heading: "Where Site Clinic API, MCP, scheduler, and Blog Writer fit",
        body: [
          {
            kind: "paragraphs",
            paragraphs: [
